...
exports.demo = demo;
const ExternalInterface_1 = require("./interface/ExternalInterface");
function demo() {
    console.log("=== PHASE 0: Privacy-First System Demo ===\n");
    // Create the system
    const { interface: externalAPI, vault } = (0, ExternalInterface_1.createSystem)();
    ...
    ageProofs.forEach((proof) => {
        console.log(`  Type: ${proof.proofType}, Valid: ${proof.isValid}, Expires: ${new Date(proof.expiresAt || 0).toISOString()}`);
    });
